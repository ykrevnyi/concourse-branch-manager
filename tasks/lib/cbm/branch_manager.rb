...
module Cbm
  ...
  class BranchManager
    ...
    attr_reader :common_resources_template, :common_jobs_template, :group_per_branch, :resource_type_template_file
    ...
    def initialize
      ...
      @common_jobs_template = ENV.fetch('PIPELINE_COMMON_JOBS_TEMPLATE', nil)
